...
public final class StdIn {
    ...
    private static final Pattern EVERYTHING_PATTERN = Pattern.compile("break");
   ...
   /**
    ...
    /**
     * change the scanner resource path by yourself 
     * @param filepath
     */
    public static void setScanner(String filepath) {
